...
configure do
  ...
  set :city_name,               'em Viana do Castelo'                         # Include the preposition (em Coimbra, no Porto, etc.)
  set :meta_keywords,           'viana do castelo,made in viana'
  ...
  set :site_url,                'https://oquefazfaltaemviana.herokuapp.com'      # Used for facebook comments. No trailing slash please.
  set :fb_app_id,               '803116486532669'                    # You should create a facebook app to moderate comments
